...
export default function CaseCard({ data }: { data: Case }) {
  return (
    <article className="group flex h-full flex-col rounded-2xl border border-white/[0.06] bg-graphite-900/60 p-6 shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:border-accent-indigo/30 hover:shadow-card-hover md:p-7">
